...
south and east. The exit is to the west.""",
    ...
    "exits": {"south": "Admins", "east": "Tutor", "west": "Parking"}  # COMPLETED
}
...
ignore you. To the north is the reception.""",
    ...
    "exits": {"north": "Reception"}  # COMPLETED
}
...
pack of biscuits. The reception is to the west.""",
    ...
    "exits": {"west": "Reception"}  # COMPLETED
}
...
general office.""",
    ...
    "exits": {"south": "Reception", "east": "Office"}  # COMPLETED
}
