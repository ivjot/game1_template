...
def normalise_input(user_input):
    ...
    """
    # remove punctuation
    text_no_punct = remove_punct(user_input)

    # remove leading and trailing spaces
    text_no_spaces = remove_spaces(text_no_punct)

    # convert to lowercase
    normalised_text = text_no_spaces.lower()
...
def exit_leads_to(exits, direction):
    ...
    'Reception'
    """
    # get the key of the next room
    next_room_key = exits[direction]
    # return the room's name
    return rooms[next_room_key]["name"]
...
def print_menu(exits):
    ...
    for direction in exits:
        ...
        room_name = exit_leads_to(exits, direction)
        print_menu_line(direction, room_name)
...
def move(exits, direction):
    ...
    # look up the key of the next room from the exits dictionary
    next_room_key = exits[direction]
    
    # return the full room dictionary from rooms
    return rooms[next_room_key]
